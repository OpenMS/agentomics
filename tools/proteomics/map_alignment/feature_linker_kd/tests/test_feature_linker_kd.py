...
class TestLinkFeaturesKd:
    ...
    def test_consensus_file_loadable(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            link_features_kd(input_paths, output_path, rt_tol=30.0, mz_tol=0.01)
